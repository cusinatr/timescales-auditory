"""
Plot baseline 1/f exponent on electrodes in MNI space in HIPPOCAMPUS & AMYGDALA.
...
where the exponent for each channel are already stored and coords_file_name,
...
cbar = fig_glass.colorbar(p, cax=cax, format="%d", orientation="horizontal")
cbar.set_label(label="Baseline exponent [a.u.]", size=fsize.LABEL_SIZE)
